      ...
      <Scrollbars>
        ...
        <div className={classes.textLeft}>
          ...
          <Paper className={classes.root} elevation={1}>
            ...
            <Typography component="p" style={{ whiteSpace: 'pre-line' }}>
              本サービスでは、ログインに必要な利用者自らが所有するTwitter（http://twitter.com）のアカウント（以下、「Twitterアカウント」といいます。）に関する情報（名前、ユーザー名、アイコン画像URL）と投稿テーマ、Twitterアカウントに結びついた投稿テーマに対する好き嫌いに関する情報を保存しています。これらは本サービス利用の範囲内で管理者並びに管理者と契約関係にあるパートナー社（アクセス解析など）の間で利用されます。
            </Typography>
            <Typography component="p" style={{ whiteSpace: 'pre-line' }}>
              管理者は、事前に利用者の投稿内容を閲覧することはしません。従って、投稿の内容（真偽、正確性、第三者の権利を侵害していないこと等）やサービス利用の状態については一切保証しておりません。本サービスのご利用は、利用者ご自身の責任において行っていただきます。
            </Typography>
